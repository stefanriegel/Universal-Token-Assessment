...
export const VNIOS_SPECS: ApplianceSpec[] = [
  ...
  // ─── ND series (Network Discovery appliance) ─────────────────────────────
  // User-supplied specs 2026-07-04: VMware 16/64 (Infoblox internal sizing table),
  // Azure 20/160 (official Azure doc). Generation bucketed as X6 (contemporary).
  { model: 'ND-V1606', generation: 'X6', platform: 'VMware', defaultVariantIndex: 0,
    variants: [{ configName: 'Standard', vCPU: 16, ramGB: 64 }] },
  { model: 'ND-V1606', generation: 'X6', platform: 'Azure', defaultVariantIndex: 0,
    variants: [{ configName: 'Standard', vCPU: 20, ramGB: 160 }] },
];

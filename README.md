...
brew trust stefanriegel/tap
brew install universal-token-assessment
```

The one-time `brew trust` also lets the in-app auto-updater run `brew upgrade` without failing.
...
**Prerequisites:** Go 1.25.6+, Node.js 22+, pnpm

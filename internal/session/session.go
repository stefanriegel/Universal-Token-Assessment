...
type Session struct {
	...
	// NiosMicrosoftServersJSON holds JSON-encoded NiosMicrosoftServers from the NIOS
	// backup scan. nil if NIOS was not scanned or no MS-managed servers were found.
	NiosMicrosoftServersJSON []byte

	// NiosMicrosoftAllocationJSON holds the JSON-encoded Microsoft allocation
	// snapshot from the NIOS backup scan. nil when NIOS was not scanned.
	NiosMicrosoftAllocationJSON []byte
...
// SetNiosMicrosoftServersJSON stores the JSON-encoded Microsoft-server summary.
func (s *Session) SetNiosMicrosoftServersJSON(data []byte) {
	s.mu.Lock()
	defer s.mu.Unlock()
	s.NiosMicrosoftServersJSON = data
}

// SetNiosMicrosoftAllocationJSON stores the JSON-encoded Microsoft allocation
// snapshot in the session.
func (s *Session) SetNiosMicrosoftAllocationJSON(data []byte) {
	s.mu.Lock()
	defer s.mu.Unlock()
	s.NiosMicrosoftAllocationJSON = data
}
